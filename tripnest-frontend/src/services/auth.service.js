...
/**
 * Store the OAuth2 user data (received via redirect query params) into
 * localStorage using the same shape as a regular JWT login response.
 */
const loginWithOAuth2Token = (userData) => {
