      ...
      <div className="page-content">
        <div className="page-header">
          <div>
            ...
            <p className="page-subtitle">{trips.length} adventure{trips.length !== 1 ? 's' : ''} planned</p>
          </div>
        ...
        {loading ? (
          ...
          <div className="empty-state section-card">
            <p>No trips found. <Link to="/trips/new" className="link">Start planning your next adventure!</Link></p>
          </div>
        ) : (
